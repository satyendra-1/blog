...
const Header = () => {
  ...
  return (
    ...
    <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-priary/40 bg-primary/10 rounded-full text-sm'>
      <p>AI feature is integrated</p>
      <img src={assets.star_icon} className='w-2.5 ' alt=""/>
    </div>
    
      <h1 className="text-3xl sm:text-6xl fonr-semibold sm:leading-16 text-gray-700"> Your <span className="text-primary">Blogging</span> Platform.</h1>
      <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">
        This is your personal space htink,speak,write, share and discover. Write your thoughts, stories, ideas, and connect with others.
      </p>
